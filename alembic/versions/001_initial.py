...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('body_measurements', JSONB, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('fabric_url', sa.String(length=500), nullable=True),
        sa.Column('fabric_name', sa.String(length=255), nullable=True),
        sa.Column('client_measurements', JSONB, nullable=True),
        sa.Column('garment_specs', JSONB, nullable=True),
